...
// «lunes» … «domingo» se dicen en un solo sitio del dominio. La recurrencia de
// rutinas ya los nombraba y este módulo nació con su propia copia: dos nombres
// iguales exportados por el mismo barril, y la misma frase con dos verdades el
// día que una de las dos cambie.
import { weekdayName } from "./recurrence.js";
