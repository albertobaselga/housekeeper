...
INSERT INTO app.routines (household_id, title, details, audience, next_due_hint, created_by_membership_id,
  pattern, anchor_on, repeat_every) VALUES
  ('${FIXTURE_HOUSEHOLD}', 'Regar plantas', 'Terraza y salón', 'all', '2026-08-10', '${ADMIN_MEMBERSHIP}', 'every_n_days', '2026-08-10', 7),
  ('${FIXTURE_HOUSEHOLD}', 'Planificar el menú', '', 'family', '2026-08-09', '${ADMIN_MEMBERSHIP}', 'every_n_days', '2026-08-09', 7),
  ('${FIXTURE_HOUSEHOLD}', 'Repaso de uniformes', '', 'employee', '2026-08-11', '${ADMIN_MEMBERSHIP}', 'every_n_days', '2026-08-11', 7);
